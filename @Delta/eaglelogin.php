...
if($_SERVER["REQUEST_METHOD"]=="POST"){
  ...
  $login=false;
	...
	$password =$_POST["password"];
	  $sql="SELECT * FROM `eagles` WHERE name='$username' AND email='$email'  ";
...
background-image: url("wall/abstract-winter-storm-3840x2160.jpg"); background-repeat:no-repeat ; background-size:cover;}</style>
    <body class="text-center">
        ...
        <form action="eaglelogin.php" class="form-signin" method="POST">
            ...
            <div class="checkbox mb-3">
                     ...
                     <label><a href="eaglesignup.php"> Don't  Have Account Yet?</label>
            </div>
